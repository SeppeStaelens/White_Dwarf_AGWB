...
class SFRInterpolator:
    ...
    def __init__(
        self,
        redshift_interpolator: ri.RedshiftInterpolator,
        SFH_num: int = 1,
        SFH_type: str = "MZ19",
        metallicity: str = "z02",
        max_z: float = 8.0,
        ...
        if SFH_num == 1:
            ...
            SFR_at_val_data = pd.read_csv(
                Path(f"../data/SFRD/{SFH_type}_SFRD_allbins.txt")
            )
            ...
            if metallicity == "z03":
                ...
                raise ValueError(
                    "Invalid metallicity value. Choose from 'z03', 'z02', 'z01', 'z005', 'z001' or 'z0001'."
                )
    ...
    def representative_SFH(self, age: float, Delta_t: float = 0.0) -> float:
        """!
