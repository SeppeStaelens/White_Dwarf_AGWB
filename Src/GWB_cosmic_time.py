...
class sim_model:
    ...
    '''
    def __init__(self, N = 50, N_t = 20, max_z = 8, SFH_num = 1, log_f_low = -5, log_f_high = 0) -> None:
        self.N = N
        self.N_t = N_t
        self.max_z = max_z
    ...
    def calculate_cosmology(self):
        ...
        self.z_list = interp(self.ages.value, interp_age, interp_z)
...
def main():
    ...
    model = sim_model(N, N_t, max_z, SFH_num)
